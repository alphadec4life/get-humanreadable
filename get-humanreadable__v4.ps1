#2022-11-23 Latest execution and script is looking good. There may be some issues that need verified mentioned on the 11/21 notes below with the initial # type-cast
#is set to string but will be fully test/verified before the final version is used.
